...
def validate(records: list[dict[str, Any]], parse_errors: list[str], manifest: dict[str, Any]) -> dict[str, Any]:
...
def result(verdict: str, errors: list[str], warnings: list[str], metrics: dict[str, Any],
           ...
           events: dict[str, int] | None = None) -> dict[str, Any]:
    return {
        "verdict": verdict,
        "errors": errors,
        "warnings": warnings,
...
def main() -> int:
    ...
    analysis = validate(records, parse_errors, manifest)
