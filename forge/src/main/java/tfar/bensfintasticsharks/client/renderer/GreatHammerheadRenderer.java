...
public class GreatHammerheadRenderer extends GeoEntityRenderer<GreatHammerheadSharkEntityForge> {
    ...
    @Override
    protected void applyRotations(GreatHammerheadSharkEntityForge animatable, com.mojang.blaze3d.vertex.PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick) {
