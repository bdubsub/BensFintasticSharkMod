...
public class CommonThresherRenderer extends GeoEntityRenderer<CommonThresherSharkEntityForge> {
    ...
    @Override
    protected void applyRotations(CommonThresherSharkEntityForge animatable, com.mojang.blaze3d.vertex.PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick) {
