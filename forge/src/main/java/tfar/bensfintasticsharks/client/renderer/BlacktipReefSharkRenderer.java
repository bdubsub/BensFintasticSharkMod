...
public class BlacktipReefSharkRenderer extends GeoEntityRenderer<BlacktipReefSharkEntityForge> {
    ...
    @Override
    protected void applyRotations(BlacktipReefSharkEntityForge animatable, com.mojang.blaze3d.vertex.PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick) {
