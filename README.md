...
* A reusable permission level two `/bfs debug followme` stick for bounded testing of every mob family, including BFS species, vanilla bosses, and compatible third party mobs. Leases use normal navigation, release on arrival or lifecycle boundaries, restore ordinary behavior, and report rejected clicks in chat.
