...
The post route repair server suite completed all 88 registered tests, including the sting cooldown regression and the existing debug lifecycle tests. Forge tests passed 52, debug parser tests passed 18 and performance analysis tests passed 21.
...
The workload repair uses the existing `STING_DURATION_TICKS` value as a per target sting cooldown and prevents only the common stingray and american lobster pair from selecting each other as food. Other benthic food routes and all apex predation remain enabled. The final rebuilt candidate with JAR SHA 256 `1195f91046da64a3f2ea4f9548c4346a6106ee7e24b87d8b9398c170ab58444` and SHA 512 `b018cae01f78d43f4661a7a6df207d197f81f9fc3a789d766d9312f3e019b2b93122a8a76df1517367b1e3fb63b0cfb540617c1dce0f793a5a184600c8bd2abd` completed a 3,400 tick diagnostic pilot after a 200 tick warmup. The live population stayed between 61 and 63, with nine deaths from retained shark predation and no lobster deaths from stingrays. The pilot measured p50 3.690514 ms, p95 9.493492 ms, p99 17.003300 ms and maximum 26.212763 ms. Its timing CSV SHA 256 is `b8c7f1207bf167e0a6232a6fb8000c78d5d41681312ac84df436f89a24a04be9`, census TSV SHA 256 is `f9670205832736d9d26883a8d4df977f7e5bacf8d4bd180162b126ed309c97d6`, completion record SHA 256 is `0dc236a9e7127e9992437a8011c42d652a373df884a5d92f0b9804861b44bdfe`, and console SHA 256 is `831e57aa2a80f4b9f612ae7b10474ee06a6a8ced03984499638c310e5b79f9bb`. This is a workload repair pilot, not the required four case matrix.
